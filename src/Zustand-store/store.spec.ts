...
import { useStore as store, useStore } from '.'
...
describe('zustand store', () =>{
  ...
  it('should be able to play', () =>{
    ...
    const {currentModuleIndex, currentLessonIndex } = useStore()
...
it('should be able to jump next module automatically ', () =>{
  store.setState({course})
...
it('should not update the current module and lesson index if there is no next lesson avalable ', () =>{
